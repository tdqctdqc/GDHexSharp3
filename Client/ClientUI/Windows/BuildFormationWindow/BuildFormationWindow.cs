...
public class BuildFormationWindow : WindowDialog
{
    ...
    {
        Popup_();
        _typeList = new ListContainer<UnitType>(_data.UnitTypes.List.Where(t => t.IsHQ).ToList());
    ...
    public void Build()
    {
        ...
        UnitGenerator.BuildFormation(hex, faction, _typeList.Selected, _rankList.Selected, Colors.Yellow, Colors.Green);
        SelectedParam();
    }
