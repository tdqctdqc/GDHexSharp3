...
public class RiverModel : IModel
{
    public string TableNameI => TableName; 
    public static string TableName = "River";

    public int ID { get; set; }
    public BackingModel Backing { get; private set; }
    public int NumFields => 4;
    public int RiverTypeID
    { get => _riverTypeID; 
        set { _riverTypeID = value; Backing.Fields[0] = value.ToString(); }
    }
    private int _riverTypeID;
    public int FromID 
    { get => _fromID; 
    ...
    public RiverType RiverType => Game.I.Session.Data.RiverTypes[RiverTypeID];
    public float Angle => Hex1.GetHexAngle(Hex2) + Mathf.Pi / 2f;
    public RiverModel(){}
    public RiverModel(int id, int hexPairID, int typeID, int from, int to)
    {
        ID = id; 
    ...
    {
        RiverTypeID = Backing.Fields[0].ToInt();
